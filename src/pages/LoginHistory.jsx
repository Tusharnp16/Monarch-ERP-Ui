...
const LoginHistory = () => {
  ...
  return (
    /* Use a Fragment <> instead of <div> to avoid breaking the parent's layout */
    <>
      {/* Topbar: This will now sit correctly at the top of the parent's main area */}
      <div className="sticky-top bg-white border-bottom p-3 d-flex align-items-center justify-content-between">
        ...
        <div className="d-flex align-items-center gap-3">
          <span className="badge bg-light text-dark border px-3 py-2">
            User: <span>{userName || "admin8"}</span>
          </span>
          <button
          ...
          >
            <i
              className={`fa-solid fa-sync ${loading ? "fa-spin" : ""} me-1`}
            ></i>
            Refresh
          </button>
        </div>
        ...
        <div className="row mb-4">
          <div className="col-md-4">
            <div className="card border-0 shadow-sm p-3 d-flex flex-row align-items-center gap-3">
              <div
                className="bg-primary bg-opacity-10 text-primary rounded p-3"
                style={{
                  width: "50px",
                  height: "50px",
                  display: "flex",
        ...
        <div className="card border-0 shadow-sm overflow-hidden">
            ...
            <div className="table-responsive">
              <table className="table table-hover align-middle mb-0">
                <thead className="table-light">
                  <tr>
                    <th
                      className="ps-4 text-muted small text-uppercase"
                      style={{ width: "100px" }}
                    >
                      No.
                    </th>
          ...
          <div className="card-footer bg-white text-center py-3">
            <p className="text-muted small mb-0">
              Security Note: If you don't recognize a login session, change your
